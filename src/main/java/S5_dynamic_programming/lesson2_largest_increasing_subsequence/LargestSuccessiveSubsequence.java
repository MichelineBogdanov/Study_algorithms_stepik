package S5_dynamic_programming.lesson2_largest_increasing_subsequence;
 ...
 * Выведите максимальное 1≤k≤n, для которого найдётся подпоследовательность 1≤i1≤i2≤...≤ik≤in длины k,
 * в которой каждый элемент делится на предыдущий (формально: для всех 1≤j≤k, A[ij]/A[i(j+1)])
 * ---
 * Sample Input:
 * 4
 * 3 6 7 12
